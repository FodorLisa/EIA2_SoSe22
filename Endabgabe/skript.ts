namespace Endabgabe {
    ...
    function firstGrowthPhaseSalad(_position: Vector): void {
        crc2.beginPath();
    ...
    function firstGrowthPhasePumpkin(_position: Vector): void {
        crc2.beginPath();
        crc2.arc(_position.x + 62.5, _position.y + 42, 5, 0, 2 * Math.PI);
        crc2.stroke();
    ...
    function firstGrowthPhaseCarrot(_position: Vector): void {
        crc2.beginPath();
        crc2.arc(_position.x + 62.5, _position.y + 42, 5, 0, 2 * Math.PI);
        crc2.stroke();
    ...
    function firstGrowthPhaseRadish(_position: Vector): void {
        crc2.beginPath();
        crc2.arc(_position.x + 62.5, _position.y + 42, 5, 0, 2 * Math.PI);
        crc2.stroke();
    ...
    function firstGrowthPhaseCorn(_position: Vector): void {
        crc2.beginPath();
        crc2.arc(_position.x + 62.5, _position.y + 42, 5, 0, 2 * Math.PI);
        crc2.stroke();
    ...
    function secondGrowthPhaseSalad(_position: Vector): void {
            crc2.beginPath();
    ...
    function secondGrowthPhasePumpkin(_position: Vector): void {
            crc2.beginPath();
            crc2.ellipse(_position.x , _position.y, 5, 10, Math.PI / 3, 0, 2 * Math.PI);
            crc2.stroke();
            crc2.fillStyle = "#ff7518";
    ...
    function secondGrowthPhaseCarrot(_position: Vector): void {
            crc2.beginPath();
            crc2.ellipse(_position.x , _position.y, 5, 10, Math.PI / 3, 0, 2 * Math.PI);
            crc2.stroke();
            crc2.fillStyle = "#ed9121";
    ...
    function secondGrowthPhaseRadish(_position: Vector): void {
            crc2.beginPath();
            crc2.ellipse(_position.x , _position.y, 5, 10, Math.PI / 3, 0, 2 * Math.PI);
            crc2.stroke();
            crc2.fillStyle = "#A74FB0";
    ...
    function secondGrowthPhaseCorn(_position: Vector): void {
            crc2.beginPath();
            crc2.ellipse(_position.x , _position.y, 5, 10, Math.PI / 3, 0, 2 * Math.PI);
            crc2.stroke();
            crc2.fillStyle = "#FFFC3A";
    ...
    //Fertiges Gemüse
    function CornFinished(_position: Vector): void {
        crc2.beginPath();
    ...
    function CarrotFinished (_position: Vector): void {
        crc2.beginPath();
    ...
    function RadishFinished (_position: Vector): void {
        crc2.beginPath();
    ...
    function PumpkinFinished (_position: Vector): void {
        crc2.beginPath();
    ...
    function Parasite(_position: Vector): void {
        crc2.beginPath();
